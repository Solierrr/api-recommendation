...
class EventRepository:
    @staticmethod
    async def log_event(session: AsyncSession, user_id: str, candidate_id: str, event_type: str) -> bool:
        ...
        RETURN r
        """
        result = await session.run(query, candidate_id=candidate_id, user_id=user_id, event_type=event_type)
